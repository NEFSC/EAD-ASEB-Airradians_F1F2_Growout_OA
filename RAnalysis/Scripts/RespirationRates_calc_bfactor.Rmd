...
Resp.Master_OM <- Resp.Master[!is.na(Resp.Master$Length_um),] %>% 
  ...
  dplyr::mutate(volume = 
            ...
            case_when(
                      ...
                      filetype == "LoLigo_data" & Date %in% c('10/26/2021') & Channel == 'CH1' ~ 23.1, # F1 data, lower values
...
write.csv(Resp.Master_OM, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/RR_calc_raw.csv")
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/MetabolicScaling_bFactor_TDW_OM.pdf"), width = 8, height = 16)
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/F1_F2_RR_bFactor_TDW_LowvMod.pdf"), 
    width = 5, height = 10)
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/F2_RR_bFactor_TDW_LowvHigh.pdf"), 
    width = 5, height = 5)
...
### summary:
* all
-   TDW b factor total = 0.923
* Generation
-  F1 TDW b factor  = 0.903
-  F2 TDW b factor  = 0.955
* treamtent
-   Low pCO2 TDW b factor  = 0.91
-   Moderate pCO2 TDW b factor  = 0.897
-   High pCO2 TDW b factor  = 1.05
*  treamtent x Generation
F1
-   Low pCO2 F1 TDW b factor  = 0.928
-   Moderate pCO2 F1 TDW b factor  = 0.813
F2
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/MetabolicScaling_bFactor_TDW_OM_biovolcalc.pdf"), width = 8, height = 8)
...
# OUTPUT PLOTS 
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/MetabolicScaling_bFactor_LENGTH.pdf"), width = 8, height = 16)
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/F1_F2_RR_bFactor_Length_LowvMod.pdf"), 
    width = 5, height = 10)
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/metabolic_scaling/F2_RR_bFactor_Length_LowvHigh.pdf"), 
    width = 5, height = 5)
...
Generation
-   Length b factor pCO2 F1 = 2.36
-   Length b factor pCO2 F2 = 1.74 
-   Length b factor pCO2 F3 = 8.38
Treatment
-   Length b factor pCO2 low = 2.23
-   Length b factor pCO2 moderate = 2.06
-   Length b factor pCO2 high = 2.5
Generation * Treatment
F1
-   Length b factor pCO2 low = 2.4
-   Length b factor pCO2 moderate = 2.31
F2
...
bTDW = 0.903 # review the outlier-omitted b factor plot in previous chunk
bLength.all = 2.36 # review the outlier-omitted b factor plot in previous chunk

# assign bfactors by treatment
bTDW.low <-  0.928 #mean data by rep tank # 6.99 - with all data
bTDW.mod <-  0.813 #mean data by rep tank # 6.57 - with all data

bLength.low <-  2.4 #mean data by rep tank # 6.99 - with all data
bLength.mod <-  2.31 #mean data by rep tank # 6.57 - with all data
...
write.csv(RR_formatted_F1smaster, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/F1/F1_RR_calc_master.csv")
...
RR_formatted_F2smaster <- RR_master_F2 %>% 
                              ...
                              dplyr::select(c(Gen,
                                              ...
                                              resp_umol_hr_bFactorNormLength.MEAN_LvH))
#View(RR_formatted_F1smaster)
write.csv(RR_formatted_F2smaster, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/F2/F2_RR_calc_master.csv")
...
RR_formatted_F3smaster <- RR_master_F3 %>% 
                            ...
                            dplyr::select(c(Gen,
                                            ...
                                            resp_umol_hr_bFactorNormLength.MEAN))
#View(RR_formatted_F1smaster)
write.csv(RR_formatted_F3smaster, "C:/Users/samjg/Documents/Github_repositories/EAD-ASEB-Airradians_F1F2_Growout_OA/RAnalysis/Output/Respiration/F3/F3_RR_calc_master.csv")
```
